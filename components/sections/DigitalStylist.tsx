                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="animate-fadeRight">
                        ...
                        <p className="font-sans text-[#555] text-lg leading-relaxed mb-10 max-w-[500px]">
                            From finding your perfect style to designing a bespoke masterpiece from scratch—our AI-powered studio brings 35 years of heritage into your hands.
                        </p>
